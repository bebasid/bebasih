...
<p align="center">
    <img src="https://raw.githubusercontent.com/bebasid/bebasid/master/dev/resources/logo-black.svg#gh-light-mode-only" alt="BebasID Logo White" width="445">
    <img src="https://raw.githubusercontent.com/bebasid/bebasid/master/dev/resources/logo.svg#gh-dark-mode-only" alt="BebasID Logo Black" width="445"><br>
...
## BebasIH
Dengan BebasID, anda dapat membuka halaman situs web yang diblokir dengan memanfaatkan [_hosts file_](<https://en.wikipedia.org/wiki/Hosts_(file)>) yang sudah mempunyai otomatis update.

#### Antarmuka Pengguna Grafis (GUI)
Anda dapat menggunakan [aplikasi BebasIH](https://github.com/bebasid/bebasid/releases/tag/v1.1) untuk menginstal hosts BebasIH lewat GUI.

![bebasih.exe dijalankan di Windows 10](https://i.imgur.com/Bcq0rgm.png)
...
Anda dapat menggunakan [aplikasi skrip batch BebasID](https://github.com/bebasid/bebasid/releases/tag/v1.1). *Aplikasi ini menggunakan hanya manual saja.*

![bebasid.bat dijalankan di Windows 10](https://i.imgur.com/CrnySId.png)

### Metode Lain
**BebasIH Source (Kode Sumber):**
...
Untuk membantu pengembangan BebasIH, silakan kunjungi [KONTRIBUSI](https://github.com/bebasid/bebasid/blob/master/CONTRIBUTING.md).
